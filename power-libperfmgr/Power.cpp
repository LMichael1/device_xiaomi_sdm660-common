...
#ifndef TAP_TO_WAKE_NODE_PLATINA
#define TAP_TO_WAKE_NODE_PLATINA "/proc/touchpanel/wake_gesture"
#endif
...
Return<void> Power::setFeature(Feature feature, bool activate)  {
    switch (feature) {
        ...
        case Feature::POWER_FEATURE_DOUBLE_TAP_TO_WAKE:
			...
			::android::base::WriteStringToFile(activate ? "1" : "0", TAP_TO_WAKE_NODE_PLATINA, true);
            break;
#endif
        default:
            break;
